...
,
"us"
, or "our") collects, uses, and discloses your personal information when you
visit, use our services, or make a purchase from (the "Site") or otherwise communicate with us (collectively, the "Services"). For purposes of this Privacy
Policy,
"you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we
...
<br/> <br/><h3 className="text-2xl">How We Collect and Use Your Personal Information</h3>
...
others.
<br/>
<br/><h3 className="text-2xl">What Personal Information We Collect</h3>
...
, we are referring to information that identifies, relates to, describes or can be associated with you. The following sections
describe the categories and specific types of personal information we collect.
Information We Collect Directly from You
Information that you directly submit to us through our Services may include:<br/>
...
behalf, such as:
<br/>
- Companies who support our Site and Services, such as Timely, Meta, Google and Vercel.<br/>
...
<h3 className="text-2xl">How We Use Your Personal Information</h3>
...
including to process your payments, provide our services, to send notifications to you related to you account, purchases, returns, exchanges or other
...
interests in order to be responsive to you, to provide effective services to you, and to maintain our business relationship with you.<br/>
<br/><h3 className="text-2xl">Cookies</h3><br/>
...
on our Site and other websites.<br/>
...
<br/>
<h3 className="text-2xl">How We Disclose Personal Information</h3>
...
- With business and marketing partners, including Google and Meta, to provide services and advertise to you. Our business and marketing partners will use your information in accordance with their own privacy notices.<br/>
...
rights of our users or others.<br/>
...
<h3 className="text-2xl">User Generated Content</h3>
...
area of the Services, this content will be public and accessible by anyone. <br/>
...
<h3 className="text-2xl">Third Party Websites and Links</h3>
...
<br/><br/>
<h4 className="text-2xl">Children's Data</h4>
